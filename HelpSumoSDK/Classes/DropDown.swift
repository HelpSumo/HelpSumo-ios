...
public final class DropDown: UIView {
	...
	*/
     ...
     */
	public var cellNib = UINib(nibName: "DropDownCell", bundle: Bundle(url: (Bundle(for:  TicketHomeController.self).resourceURL?.appendingPathComponent( "HelpSumoSDK.bundle"))!)) {
		didSet {
